...
_CASES: tuple[KernelCase, ...] = (
    KernelCase(
        ...
        family="moe",
        builder="tilekernels_ptodsl.moe.normalize_weight:build_normalize_weight",
        status="implemented",
    ...
    KernelCase(
        ...
        family="moe",
        builder="tilekernels_ptodsl.moe.mask_indices_by_tp:build_mask_indices_by_tp",
        status="implemented",
    ...
    KernelCase(
        ...
        family="moe",
        builder="tilekernels_ptodsl.moe.group_count:build_group_count",
        status="implemented",
    ...
    KernelCase(
        name="moe.aux_fi",
        family="moe",
        builder="tilekernels_ptodsl.moe.aux_fi:build_aux_fi",
        status="implemented",
    ...
    KernelCase(
        name="moe.topk_gate",
        family="moe",
        builder="tilekernels_ptodsl.moe.topk:build_topk_gate",
        status="implemented",
    ...
    KernelCase(
        ...
        family="moe",
        builder="tilekernels_ptodsl.moe.topk:build_topk_sum_and_topk_group_idx",
        status="implemented",
    ...
    KernelCase(
        ...
        family="moe",
        builder="tilekernels_ptodsl.moe.inplace_unique_group_indices:build_inplace_unique_group_indices",
        status="implemented",
    ...
    KernelCase(
        ...
        family="transpose",
        builder="tilekernels_ptodsl.transpose.transpose:build_transpose",
        status="implemented",
    ...
    KernelCase(
        ...
        family="transpose",
        builder="tilekernels_ptodsl.transpose.transpose:build_batched_transpose",
        status="implemented",
    ...
    KernelCase(
        ...
        family="engram",
        builder="tilekernels_ptodsl.engram.fused_weight:build_fused_weight",
        status="implemented",
    ...
    KernelCase(
        ...
        family="engram",
        builder="tilekernels_ptodsl.engram.hash:build_engram_hash",
        status="implemented",
    ...
    KernelCase(
        ...
        family="engram",
        builder="tilekernels_ptodsl.engram.grad_w_reduce:build_grad_w_reduce",
        status="implemented",
    ...
    KernelCase(
        ...
        family="engram",
        builder="tilekernels_ptodsl.engram.gate:build_gate_fwd",
        status="implemented",
    ...
    KernelCase(
        ...
        family="engram",
        builder="tilekernels_ptodsl.engram.gate:build_gate_bwd",
        status="implemented",
    ...
    KernelCase(
        ...
        family="mhc",
        builder="tilekernels_ptodsl.mhc.expand_to_mhc:build_expand_to_mhc_fwd",
        status="implemented",
    ...
    KernelCase(
        ...
        family="mhc",
        builder="tilekernels_ptodsl.mhc.expand_to_mhc:build_expand_to_mhc_bwd",
        status="implemented",
    ...
    KernelCase(
        ...
        family="mhc",
        builder="tilekernels_ptodsl.mhc.pre_apply_mix:build_pre_apply_mix_fwd",
        status="implemented",
    ...
    KernelCase(
        ...
        family="mhc",
        builder="tilekernels_ptodsl.mhc.pre_apply_mix:build_pre_apply_mix_bwd",
        status="implemented",
    ...
    KernelCase(
        name="mhc.post_fwd",
        family="mhc",
        builder="tilekernels_ptodsl.mhc.post:build_post_fwd",
        status="implemented",
    ...
    KernelCase(
        name="mhc.post_bwd",
        family="mhc",
        builder="tilekernels_ptodsl.mhc.post:build_post_bwd",
        status="implemented",
    ...
    KernelCase(
        ...
        family="mhc",
        builder="tilekernels_ptodsl.mhc.norm_fn:build_pre_norm_fn_fwd",
        status="implemented",
    ...
    KernelCase(
        ...
        family="mhc",
        builder="tilekernels_ptodsl.mhc.head_compute_mix:build_head_compute_mix_fwd",
        status="implemented",
    ...
    KernelCase(
        ...
        family="mhc",
        builder="tilekernels_ptodsl.mhc.head_compute_mix:build_head_compute_mix_bwd",
        status="implemented",
    ...
    KernelCase(
        ...
        family="mhc",
        builder="tilekernels_ptodsl.mhc.pre_split_mixes:build_pre_split_mixes_fwd",
        status="implemented",
    ...
    KernelCase(
        ...
        family="mhc",
        builder="tilekernels_ptodsl.mhc.pre_split_mixes:build_pre_split_mixes_bwd",
        status="implemented",
    ...
    KernelCase(
        ...
        family="mhc",
        builder="tilekernels_ptodsl.mhc.sinkhorn:build_sinkhorn_normalize_bwd",
        status="implemented",
